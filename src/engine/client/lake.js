...
class Lake extends ComplexShape {
    constructor(x, y, width, height) {
        ...
        this.shoreLine1 = new client.ShoreLine(x, y + height - width.percent(30), width.percent(70), width.percent(15));
        this.addShape(this.shoreLine1);

        this.shoreLine2 = new client.ShoreLine(x + width.percent(15), y + height - width.percent(15), width.percent(40), width.percent(15));
