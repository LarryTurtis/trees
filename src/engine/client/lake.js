...
class Lake extends ComplexShape {
  constructor(x, y, width, height) {
    ...
    this.shoreLine1 = new client.ShoreLine(
      x,
      y + height - width.percent(30),
      width.percent(70),
      width.percent(15)
    );
    // this.addShape(this.shoreLine1);

    this.shoreLine2 = new client.ShoreLine(
      x + width.percent(15),
      y + height - width.percent(15),
      width.percent(40),
      width.percent(15)
    );
    // this.addShape(this.shoreLine2);

    this.rectangle1 = new simples.Rectangle(
      x + width.percent(70),
      y + height - width.percent(30),
      width.percent(30),
      width.percent(15)
    );
    this.rectangle2 = new simples.Rectangle(
      x + width.percent(90),
      y,
      width.percent(10),
      width.percent(20)
    ...
    this.rectangle3 = new simples.Rectangle(
      x,
      y + height - width.percent(15),
      width.percent(15),
      width.percent(15)
    );
    this.rectangle4 = new simples.Rectangle(
      x + width.percent(55),
      y + height - width.percent(15),
      width.percent(45),
      width.percent(15)
