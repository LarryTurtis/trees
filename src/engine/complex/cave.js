...
class Cave extends ComplexShape {
    ...
    addMushroom(edge) {
        ...
        let mushroom = new complex.Mushroom(location.x, location.y - this.height.percent(5), this.width.percent(trees.random(1, 3)), this.height.percent(trees.random(4, 5)));
